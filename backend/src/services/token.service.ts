...
import {GenerateTokenResponse, SaveTokenResponse} from "../models/token.model";
import ApiError from "../utils/api-error";

const dotenv = require('dotenv')
dotenv.config()

export const saveToken = async (userId: number, refreshToken: string): Promise<SaveTokenResponse> => {
