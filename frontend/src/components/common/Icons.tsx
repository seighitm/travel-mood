...
export const Heart = ({ color, fill, size, className }: Icon) => {
  return (
    <IconWrapper color={color} fill={fill} size={size} className={className}>
      <>
...
export const Stars = ({ color, fill, size, className }: Icon) => {
  return (
    <IconWrapper color={color} fill={fill} size={size} className={className}>
      <>
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export const Refresh = ({ color, fill, size, className }: Icon) => {
  return (
    <IconWrapper color={color} fill={fill} size={size} className={className}>
      <>
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export const Cub = ({ color, fill, size, className }: Icon) => {
  return (
    <IconWrapper color={color} fill={fill} size={size} className={className}>
      <>
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export const Dots = ({ color, fill, size, className }: Icon) => {
  return (
    <IconWrapper color={color} fill={fill} size={size} className={className}>
      <>
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export const Tags = ({ color, fill, size, className }: Icon) => {
  return (
    <IconWrapper color={color} fill={fill} size={size} className={className}>
      <>
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export const LockOpen = ({ color, fill, size, className }: Icon) => {
  return (
    <IconWrapper color={color} fill={fill} size={size} className={className}>
      <>
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export const Pin = ({ color, fill, size, className }: Icon) => {
  return (
    <IconWrapper color={color} fill={fill} size={size} className={className}>
      <>
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
