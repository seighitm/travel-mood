...
import { Photo, Upload, X } from '../common/Icons';
...
interface DropzoneProfileSettingsComponentProps {
  files: File[] | Blob[];
  setFiles: Dispatch<React.SetStateAction<any>>;
}

const DropzoneProfileSettings = ({ files, setFiles }: DropzoneProfileSettingsComponentProps) => {
