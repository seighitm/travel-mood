...
interface UploadImagesSectionComponentProps {
  images: {
    name: string;
  }[];
  handlerRemoveImage: (data: string) => void;
}

const UploadImagesSection = React.memo(
  ({ images, handlerRemoveImage }: UploadImagesSectionComponentProps) => {
