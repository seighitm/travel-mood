...
import { useGetArticlesForAdmin } from '../../../api/admin/queries';
import { useNavigate } from 'react-router-dom';
import { CirclePlus } from '../../common/Icons';

const WrapperTableArticles = () => {
  ...
  const { data, refetch, isFetching, isFetched, isError } = useGetArticlesForAdmin(
    queryPageIndex,
    queryPageSize,
    queryPageFilter,
    queryPageSortBy,
...
export default WrapperTableArticles;
